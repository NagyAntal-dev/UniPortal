...
Object.entries({
  ...
  'Célonként ismétlődő kérdés: csak azok látják, akik a félév elején saját célt adtak meg — saját célonként egyszer. Az oktatói elvárásokra nem kérdez rá.': 'Repeated per goal: only respondents who set their own goals at the start of the semester see it — once per own goal. It does not ask about expectations toward teachers.',
  'Oktatónként és elvárásonként ismétlődő kérdés: oktató × elvárás páronként egyszer (2 oktató és 3 elvárás esetén 6-szor). Csak az látja, aki a félév elején oktatói elvárást adott meg; ha nincs elvárás, egyszer sem jelenik meg. Oktatónként egy összevont érték kerül be.': 'Repeated per teacher and per expectation: once for every teacher × expectation pair (6 times for 2 teachers and 3 expectations). Only respondents who stated expectations toward teachers at the start of the semester see it; with no expectations it never appears. One merged value per teacher is submitted.',
...
Object.entries({
  ...
  'Jegyzetek, parkolókártya, egyetemi termékek — fizetés az egyetem MBH-s számlájára.': 'Lecture notes, parking cards, university merchandise — payment to the university’s MBH account.',
  'Termékek': 'Products',
  ...
  'Összesen': 'Total',
  'Tovább a rendeléshez': 'Proceed to checkout',
  'Rendelés leadása': 'Place order',
  'Vissza a kosárhoz': 'Back to cart',
  'Rendelés leadva': 'Order placed',
  'Számlázási adatok': 'Billing details',
  'Név *': 'Name *',
  'Adószám (cégnek)': 'Tax number (for companies)',
  'Cím': 'Address',
  'Fizetési mód': 'Payment method',
  'Banki átutalás': 'Bank transfer',
  'Bankkártya': 'Card',
  'qvik (azonnali fizetés)': 'qvik (instant payment)',
  'Az MBH-s számlánkra, közleménnyel.': 'To our MBH account, with a payment reference.',
  'Online fizetési oldalon.': 'On an online payment page.',
  'QR-kóddal vagy linkkel a mobilbankból.': 'With a QR code or link from your mobile bank.',
  'hamarosan': 'coming soon',
  'a számlaszám még nincs megadva': 'account number not set yet',
  'Megjegyzés a rendeléshez': 'Order note',
  'A számlázási név kötelező.': 'The billing name is required.',
  'Mennyiség': 'Quantity',
  'Mégse': 'Cancel',
  'Fizetés banki átutalással': 'Payment by bank transfer',
  ...
  'Közlemény': 'Reference',
  'Határidő': 'Deadline',
  'A közleményt pontosan így írd be — ebből tudjuk a befizetést a rendelésedhez rendelni.\n        A határidő után a rendelés automatikusan lemondásra kerülhet.': 'Enter the reference exactly like this — it is how we match the payment to your order. After the deadline the order may be cancelled automatically.',
  'A rendelésed egy tétele jóváhagyáshoz kötött (pl. parkolókártya). Amint az ügyintéző döntött,\n        itt megjelenik a fizetési lehetőség. Addig nem kell fizetned.': 'An item in your order needs approval (e.g. a parking card). Once staff have decided, the payment option appears here. Until then you do not need to pay.',
  'A fizetés az online fizetési oldalon történik. Ha megszakadt, próbáld újra, vagy válassz banki átutalást.': 'Payment happens on the online payment page. If it was interrupted, try again or choose bank transfer.',
  'Ez a tétel jóváhagyáshoz kötött: fizetni csak az ügyintéző jóváhagyása után kell.': 'This item needs approval: you only pay once staff approve it.',
  'Termék': 'Product',
  'Digitális jegyzet': 'Digital notes',
  'Parkolókártya': 'Parking card',
  'Szolgáltatás': 'Service',
  'elfogyott': 'sold out',
  'jóváhagyással': 'with approval',
  ...
  'Lemondva': 'Cancelled',
  'Elutasítva': 'Rejected',
  'Visszatérítés alatt': 'Refund in progress',
  'Visszatérítve': 'Refunded',
  'Letöltés': 'Download',
  'Rendelés lemondása': 'Cancel order',
  'Még nincs rendelésed': 'You have no orders yet',
  'Nincs ilyen termék': 'No such product',
  'Válassz másik kategóriát, vagy keress másra.': 'Pick another category or search for something else.',
  'A webshop még nincs telepítve': 'The webshop is not installed yet',
  'Futtatni kell a supabase/74_webshop.sql migrációt.': 'Run the supabase/74_webshop.sql migration.',
  'Rendelések, jóváhagyások, befizetések, számlák, termékek és beállítások.': 'Orders, approvals, payments, invoices, products and settings.',
  'Rendelések': 'Orders',
  'Termékek és kategóriák': 'Products and categories',
  'Beállítások': 'Settings',
  'Bevétel összesen': 'Total revenue',
  'Elmúlt 30 nap': 'Last 30 days',
  'Fizetve, számla nélkül': 'Paid, no invoice',
  'Lejárt fizetés': 'Payment overdue',
  'Bankkivonat-tétel felismerése': 'Match a bank statement line',
  'Másold be az MBH-s kivonat közlemény rovatát: a rendszer kiolvassa a rendelésszámot, és ellenőrzi az ellenőrző számot.': 'Paste the reference field of the MBH statement: the system reads the order number and verifies the check digits.',
  'Név, e-mail, WS-szám, közlemény, rendszám, számlaszám…': 'Name, e-mail, WS number, reference, plate, invoice number…',
  'Lejártak lemondása': 'Cancel overdue orders',
  'Mind': 'All',
  'Nincs rendelés': 'No orders',
  'Rendelés': 'Order',
  'Vevő': 'Customer',
  'Tételek': 'Items',
  'Állapot': 'Status',
  ...
  'hiányzik': 'missing',
  'Fizetés': 'Payment',
  'Befizetés rögzítése': 'Record payment',
  'Fizetettnek jelölöm': 'Mark as paid',
  'Banki hivatkozás / kivonat tétel (ajánlott)': 'Bank reference / statement line (recommended)',
  'Jóváhagyás': 'Approve',
  'Elutasítás': 'Reject',
  'Indoklás (elutasításnál kötelező, a vevő látja)': 'Reason (required when rejecting; the customer sees it)',
  'Teljesítés és visszatérítés': 'Fulfilment and refund',
  'Átadva / teljesítve': 'Handed over / completed',
  'Visszatérítés indítása': 'Start refund',
  'Visszautalva': 'Refunded',
  'Megjegyzés (visszatérítésnél kötelező: ok / banki hivatkozás)': 'Note (required for refunds: reason / bank reference)',
  'A számlát a gazdasági rendszer / számlázó állítja ki (NAV Online Számla). Itt a számát és a hivatkozását rögzítjük — a vevő a „Rendeléseim” alatt látja.': 'The invoice is issued by the finance system / invoicing service (NAV Online Invoice). Here we record its number and link — the customer sees it under “My orders”.',
  'Belső megjegyzés': 'Internal note',
  '(a vevő nem látja)': '(not visible to the customer)',
  'Eseménynapló': 'Event log',
  'Lemondod ezt a rendelést? A készlet visszakerül.': 'Cancel this order? The stock will be returned.',
  'Lemondod az összes lejárt fizetési határidejű rendelést? A készlet visszakerül.': 'Cancel all orders past their payment deadline? The stock will be returned.',
  'Befizetés rögzítve.': 'Payment recorded.',
  'Tétel jóváhagyva.': 'Item approved.',
  'Tétel elutasítva.': 'Item rejected.',
  'Teljesítettnek jelölve.': 'Marked as completed.',
  'Visszatérítés elindítva.': 'Refund started.',
  'Visszatérítés lezárva.': 'Refund closed.',
  'Számla rögzítve.': 'Invoice recorded.',
  'Megjegyzés mentve.': 'Note saved.',
  'Rendelés lemondva.': 'Order cancelled.',
  ...
  'Kategória': 'Category',
  'Sorrend': 'Order',
  'Bruttó ár (Ft) *': 'Gross price (HUF) *',
  'ÁFA': 'VAT',
  'Készlet': 'Stock',
  'üres = korlátlan': 'empty = unlimited',
  'Max / rendelés': 'Max / order',
  'Jóváhagyáshoz kötött (a vevő csak jóváhagyás után fizet — pl. parkolókártya)': 'Requires approval (the customer pays only after approval — e.g. parking card)',
  'Vásárláskor bekérendő adatok': 'Data requested at purchase',
  '+ Mező': '+ Field',
  'nincs — a vevőtől nem kérünk külön adatot': 'none — no extra data requested',
  'szöveg': 'text',
  'rendszám': 'plate',
  'dátum': 'date',
  'kötelező': 'required',
  ...
  'Privát tárolóba kerül; csak a kifizetett rendelés vevője töltheti le, rövid lejáratú linkkel.': 'Stored privately; only the customer of a paid order can download it, via a short-lived link.',
  'Fájl feltöltése': 'Upload file',
  'nincs fájl': 'no file',
  'Feltöltve.': 'Uploaded.',
  'Aktív (látszik a boltban)': 'Active (visible in the shop)',
  'Mentés': 'Save',
  'Kategóriák': 'Categories',
  'Új kategória neve': 'New category name',
  'Még nincs termék': 'No products yet',
  'Ár': 'Price',
  'Eladva': 'Sold',
  'aktív': 'active',
  'rejtve': 'hidden',
  ...
  'mutat': 'show',
  '— nincs —': '— none —',
  'Banki átutalás — az egyetem MBH-s számlája': 'Bank transfer — the university’s MBH account',
  'Ezt látja a vevő a fizetési útmutatóban. Amíg a számlaszám üres, átutalással nem lehet rendelni.': 'This is what the customer sees in the payment instructions. While the account number is empty, bank-transfer orders are not possible.',
  'IBAN (opcionális)': 'IBAN (optional)',
  'Fizetési határidő (nap)': 'Payment deadline (days)',
  'Beállítások mentve.': 'Settings saved.',
  'Online fizetés': 'Online payment',
  'nincs bekötve': 'not connected',
  'Bekapcsolni itt szándékosan nem lehet: ehhez szolgáltatói szerződés (pl. MBH virtuális POS, SimplePay vagy Barion),\n            titkos kulcs és szerveroldali visszaigazolás kell. A bekötés után a pénz az egyetem MBH-s számlájára érkezik.': 'It deliberately cannot be switched on here: it needs a provider contract (e.g. MBH virtual POS, SimplePay or Barion), a secret key and server-side confirmation. Once connected, the money arrives on the university’s MBH account.',
  'Élesítés előtt': 'Before going live',
  'A webshop vásárlási feltételei (ÁSZF) — jogi iroda': 'Webshop terms and conditions — legal office',
  'Adatkezelési tájékoztató kiegészítése (rendelés, számlázási adat, rendszám)': 'Privacy notice addendum (order, billing data, licence plate)',
  'Számlázás folyamata: ki állítja ki a számlát és mikor (NAV Online Számla)': 'Invoicing process: who issues the invoice and when (NAV Online Invoice)',
  'Az egyetem MBH-s számlaszáma a fenti mezőben': 'The university’s MBH account number in the field above',
  'Online fizetéshez: szolgáltatói szerződés és bekötés': 'For online payment: provider contract and integration',
  'A banki átutaláshoz még nincs megadva az egyetem számlaszáma. Szólj a Pénzügynek.': 'The university’s account number for bank transfer has not been set yet. Please contact Finance.',
  'Ez a fizetési mód még nincs bekapcsolva.': 'This payment method is not switched on yet.',
  'Az online fizetést a szolgáltatói bekötés kapcsolja be, nem ez a kapcsoló.': 'Online payment is switched on by the provider integration, not by this switch.',
  'Egy termék már nem érhető el. Frissítsd a kosarat.': 'A product is no longer available. Refresh your cart.',
  'Ez a tétel még nem tölthető le.': 'This item cannot be downloaded yet.',
  'A rendelés nem található.': 'Order not found.',
  'Ehhez nincs jogosultságod.': 'You do not have permission for this.',
  'A letöltési link nem készült el.': 'The download link could not be created.',
  'Rendszám': 'Licence plate',
  '+ Kép': '+ Image',
  '+ Tulajdonság': '+ Attribute',
  '-tól': ' from',
  'A már megrendelt változat nem törlődik, csak kikerül az árulásból — a régi rendelések így hiánytalanok maradnak.': 'A variant that has been ordered is not deleted, only withdrawn from sale — old orders stay complete.',
  'Archivált': 'Archived',
  'Archiválva.': 'Archived.',
  'Archiválás': 'Archive',
  'Automatikus (pl. kártya aktiválása)': 'Automatic (e.g. card activation)',
  'Bekért adatok': 'Requested data',
  'Bérlet': 'Pass',
  'Cikkszám': 'SKU',
  'Dátum, helyszín, létszámkeret, névre szóló jegy.': 'Date, venue, capacity, named ticket.',
  'Ez a változat elfogyott.': 'This variant is sold out.',
  'Helyszín:': 'Venue:',
  'ISBN (könyvnél)': 'ISBN (for books)',
  'Időpont (pl. 2026-10-10 20:00)': 'Date and time (e.g. 2026-10-10 20:00)',
  'Időszakos jogosultság (edzőterem, tároló).': 'Time-limited access (gym, storage).',
  'Jegyzet, tankönyv, bögre — készlettel, átvétellel.': 'Notes, textbook, mug — with stock and pickup.',
  'Jóváhagyáshoz kötött — a vevő csak jóváhagyás után fizet': 'Requires approval — the customer pays only after approval',
  'Kiadás': 'Edition',
  'Kiadás / év': 'Edition / year',
  'Képek': 'Images',
  'Készlet (üres = ∞)': 'Stock (empty = ∞)',
  'Kézi teljesítés (ügyintéző jelöli)': 'Manual fulfilment (marked by staff)',
  'Közzétehető.': 'Ready to publish.',
  'Közzététel': 'Publish',
  'Közzétéve — a hallgatók már látják.': 'Published — students can see it now.',
  'Letölthető a fizetés után, a Rendeléseim alatt.': 'Downloadable after payment, under My orders.',
  'Letöltés fizetés után': 'Download after payment',
  'Láthatóság': 'Visibility',
  'Létesítmény': 'Facility',
  'Mentés vázlatként': 'Save as draft',
  'Mentés és közzétéve marad': 'Save (stays published)',
  'Méret × szín változatok, saját készlettel.': 'Size × colour variants with their own stock.',
  'Mérettáblázat': 'Size chart',
  'Mérettáblázat (pl. M: mellbőség 100 cm)': 'Size chart (e.g. M: chest 100 cm)',
  'Nincs változat — a termék egy darabban árulható, a készlet lent állítható.': 'No variants — the product sells as one item; set the stock below.',
  'Nyomtatott termék': 'Printed product',
  'Név a jegyre': 'Name on the ticket',
  'Névtelen termék': 'Untitled product',
  'PDF letöltés fizetés után, kurzushoz köthető.': 'PDF download after payment, can be linked to a course.',
  'Rendezvényjegy': 'Event ticket',
  'Rendszám, jóváhagyás a fizetés előtt.': 'Licence plate, approval before payment.',
  'Ruházat': 'Clothing',
  'Szabadon definiálható, kézi teljesítés.': 'Freely definable, manual fulfilment.',
  'Személyes átvétel': 'Personal pickup',
  'Szerző': 'Author',
  'Szerző:': 'Author:',
  'Szín': 'Colour',
  'Teljesítés': 'Fulfilment',
  'Tulajdonságok': 'Attributes',
  'Válaszd ki, milyen terméket viszel fel. A sablon előtölti a szükséges mezőket — minden átírható.': 'Choose what kind of product you are adding. The template pre-fills the needed fields — everything can be changed.',
  'Változat': 'Variant',
  'Változatok létrehozása / frissítése': 'Create / update variants',
  'Változatok és készlet': 'Variants and stock',
  'Vázlat': 'Draft',
  'Vázlat mentve.': 'Draft saved.',
  'eltávolítás': 'remove',
  'időablakon kívül': 'outside the sales window',
  'nincs kép': 'no image',
  'Ár (üres = alapár)': 'Price (empty = base price)',
  'Ár és ÁFA': 'Price and VAT',
  'Árulva': 'On sale',
  'Átvétel:': 'Pickup:',
  'Élő előnézet — így látja a hallgató': 'Live preview — how students see it',
  'Érvényes': 'Valid',
  'Érvényes eddig (dátum)': 'Valid until (date)',
  'Érvényes ettől (dátum)': 'Valid from (date)',
  'Érvényesség': 'Validity',
  'Érvényesség hossza (pl. 1 hónap)': 'Validity length (e.g. 1 month)',
  'Érvényesség kezdete': 'Validity start',
  '— a kurzus hallgatóinak „Neked” ajánlás': '— recommended “For you” to the course’s students',
  '— az első a borítókép': '— the first one is the cover',
  'Neked': 'For you',
  'kurzusodhoz': 'for your course',
  'Sablon': 'Template',
  'Sorrend a boltban': 'Order in the shop',
  'Kurzus': 'Course',
  'Keresés kurzuskód vagy név szerint…': 'Search by course code or name…',
  'Árulás kezdete': 'Sales start',
  'Árulás vége': 'Sales end',
  'üres = azonnal': 'empty = immediately',
  'üres = visszavonásig': 'empty = until withdrawn',
  'Tulajdonság': 'Attribute',
  'Átvételi hely és nyitvatartás *': 'Pickup point and opening hours *',
  'Teljesítés módja': 'Fulfilment method',
  'Mind': 'All',
  'ÁFA-kulcs': 'VAT rate',
  'a Pénzügy határozza meg': 'set by Finance',
  'Közzétéve': 'Published',
  'banki átutalás': 'bank transfer', 'bankkártya': 'card', 'kézi / ingyenes': 'manual / free',
...
HU_EN_PHRASES.push(
  ...
  [/^Fizetendő: (.+) \(a végleges összeget a szerver számolja\)$/, 'Payable: $1 (the final amount is calculated by the server)'],
  [/^(\d+) tétel$/, '$1 items'], [/^még (\d+) db$/, '$1 left'], [/^Rendeléseim \((\d+)\)$/, 'My orders ($1)'],
  [/^(\d+) változat$/, '$1 variants'], [/^Vázlat · (\d+)$/, 'Draft · $1'], [/^Közzétéve · (\d+)$/, 'Published · $1'], [/^Archivált · (\d+)$/, 'Archived · $1'],
  [/^A közzétételhez még hiányzik: (.+)$/, 'Still missing for publishing: $1'], [/^Közzétételhez még hiányzik: (.+)$/, 'Still missing for publishing: $1'],
  [/^Ebből a változatból már csak (\d+) db van\.$/, 'Only $1 left of this variant.'], [/^Válaszd ki a változatot(.*)$/, 'Choose the variant$1'],
  [/^A felvett kurzusodhoz: (.+)$/, 'For your course: $1'], [/^Rendelhető eddig: (.+)$/, 'Orderable until: $1'], [/^Átvétel: (.+)$/, 'Pickup: $1'],
  [/^hiányzik: (.+)$/, 'missing: $1'],
  [/^(\d+) rendelés lemondva\.$/, '$1 orders cancelled.'], [/^Hiányzó adat: (.+)$/, 'Missing data: $1'],
  [/^Elfogyott: (.+)$/, 'Sold out: $1'], [/^A feltöltés nem sikerült: (.*)$/, 'Upload failed: $1'],
  [/^(\d+) csoport$/, '$1 groups'],
