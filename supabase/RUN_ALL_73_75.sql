-- ============================================================================
-- RUN_ALL_73_75.sql — UniPortal · 2026-09-22
--
...
-- a 73, 74 és 75 hiányzik. (Ez a fájl felváltja a RUN_ALL_73_74.sql-t.)
--
--   1) 73_user_access.sql          Rendszer → Jogosultságok: egyéni menüjog és munkakör
--   2) 74_webshop.sql              Webshop: termékek, rendelés, jóváhagyás, átutalás,
--                                  számlaszám, visszatérítés
--   3) 75_webshop_editor.sql       Sablonos termékszerkesztő: változatok, képek,
--                                  vázlat/közzététel, időablak, kurzushoz kötött ajánlás
...
--
-- TUDNIVALÓK
--   * Minden rész IDEMPOTENS: ha a 73/74 már lefutott, újra lefuttatva sem árt.
--   * Nincs benne psql-parancs és tranzakciókezelés, egyben bemásolható.
--   * A futás végén „Rendben: 73 …”, „Rendben: 74 …”, „Rendben: 75 …” NOTICE-ok.
--   * NEM része ennek a fájlnak a 12_rbac_flip.sql: az szándékos, külön döntés.
-- ============================================================================


-- ==========================================================================
--  1/4 — Egyéni jogosultság és munkakör
...
-- ==========================================================================
--  3/4 — Sablonos termékszerkesztő
--  forrás: supabase/75_webshop_editor.sql
-- ==========================================================================
...
-- ==========================================================================
--  4/4 — ECHO beküldés védelme (ÚJRA, mindig utolsó)
