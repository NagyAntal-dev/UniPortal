...
# A mi saját fájljaink (volumes/functions/whatsapp-*) a sync-functions.sh-val
# kerülnek vissza — ezért a szkript a végén azt is lefuttatja.
# ============================================================================
set -eu
...
sh "$ROOT/deploy/sync-functions.sh"
echo "Kész: $DEST ($REF)"
